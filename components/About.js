...
function About() {
  return (
    ...
    <div>
      ...
      <div className="container1 text-overlay" style={{ paddingTop: "250px",paddingBottom:"80px",opacity:"initial"}} >
    ...
    style={{
      width: "1500px",
      height: "600px",
      borderRadius: "50px", // Adjust the value for desired curvature
      objectFit: "cover" // Optional: ensures the image covers the container
    }}
    alt="Image"
  />
          <div className="text-overlay" style={{ paddingTop: "400px",paddingBottom:"150px" }}>
